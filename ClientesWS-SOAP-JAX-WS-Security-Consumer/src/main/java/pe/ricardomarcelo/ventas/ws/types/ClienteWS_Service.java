 ...
 * 
 */
@WebServiceClient(name = "ClienteWS", targetNamespace = "http://ricardomarcelo.pe/ws/ventas/", wsdlLocation = "http://localhost:8080/ClientesWS-SOAP-JAX-WS-Security/ClienteWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ClientesWS-SOAP-JAX-WS-Security/ClienteWS?wsdl");
