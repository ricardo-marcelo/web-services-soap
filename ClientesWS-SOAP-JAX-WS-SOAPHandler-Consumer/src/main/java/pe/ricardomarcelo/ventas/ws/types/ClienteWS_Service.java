 ...
 * 
 */
@WebServiceClient(name = "ClienteWS", targetNamespace = "http://ricardomarcelo.pe/ws/ventas/", wsdlLocation = "http://localhost:8888/ClientesWS-SOAP-JAX-WS-SOAPHandler/ClienteWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/ClientesWS-SOAP-JAX-WS-SOAPHandler/ClienteWS?wsdl");
